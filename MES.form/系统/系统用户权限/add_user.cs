    ...
    public partial class add_user : Form
    {
        ...
        private void add_user_Load(object sender, EventArgs e)
        {
            ...
            else if (state.ToUpper()=="MOD")
            {
                ...
                this.TextBox1.Text = ((MES.form.系统.系统用户权限.sys_user_right)this.Owner).TreeView1.SelectedNode.Tag.ToString().Trim();
                this.TextBox2.Text = ((MES.form.系统.系统用户权限.sys_user_right)this.Owner).ToolStripLabel2.Text.Trim();

                cmd.Clear();
                cmd.Append("select stop_login from sys_user where login_id='" + ((MES.form.系统.系统用户权限.sys_user_right)this.Owner).ToolStripLabel2.Text.Trim() + "'");
